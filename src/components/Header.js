...
export default class Header extends React.Component {
    render() {
        ...
        let white_header = _.get(page, 'white_header', null) || false;
        return (
                ...
                <nav className={classNames('nav', {'nav--light': white_header, 'nav--dark': white_header !== true})}>
                    <div className="nav__logo" data-dark={_.get(site, 'data.config.logo_dark', null)}>
                        <Link href={withPrefix('/')}>
                            {(white_header || (_.get(page, 'layout', null) === 'product')) ? (
                    ...
                    <ul className="nav__menu">
                        {_.map(_.get(site, 'data.config.main_menu', null), (item, item_idx) => {
                            let section = _.get(page, 'section', null) || _.get(page, 'title', null);
